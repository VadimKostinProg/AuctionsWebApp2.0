...
{
    public class ParticipantAuctionCategoriesService : IParticipantAuctionCategoriesService
    {
        private readonly IRepository _repository;

        public ParticipantAuctionCategoriesService(IRepository repository)
        {
