...
{
    public class ParticipantComplaintsService : IParticipantComplaintsService
    {
        private readonly IRepository _repository;
        private readonly IUserAccessor _userAccessor;
        private readonly ILogger<ParticipantComplaintsService> _logger;

        public ParticipantComplaintsService(IRepository repository, IUserAccessor userAccessor, ILogger<ParticipantComplaintsService> logger)
        {
        ...
        public async Task<ServiceResult<ParticipantComplaintDTO>> GetComplaintByIdAsync(long complaintId)
        {
            ServiceResult<ParticipantComplaintDTO> result = new();
        ...
        public async Task<ServiceResult<PaginatedList<ParticipantSummaryComplaintDTO>>> GetUserComplaintsAsync(
            PaginationRequestDTO pagination)
        {
            ServiceResult<PaginatedList<ParticipantSummaryComplaintDTO>> result = new();
            ...
            result.Data = new PaginatedList<ParticipantSummaryComplaintDTO>
            {
                Items = entitiesList.Items.Select(e => e.ToParticipantSummaryDTO()).ToList(),
                Pagination = new()
                {
        ...
        public async Task<ServiceResult> PostComplaintAsync(ParticipantPostComplaintDTO complaintDTO)
        {
