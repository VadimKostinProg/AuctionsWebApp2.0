...
{
    public class ModeratorSupportTicketsService : IModeratorSupportTicketsService
    {
        private readonly IRepository _repository;
        private readonly ILogger<ModeratorSupportTicketsService> _logger;
        private readonly ITransactionsService _transactionsService;
        private readonly IUserAccessor _userAccessor;

        public ModeratorSupportTicketsService(IRepository repository, 
            ILogger<ModeratorSupportTicketsService> logger, 
        ...
        public async Task<ServiceResult> AssignSupportTicketAsync(ModeratorAssignSupportTicketDTO requestDTO)
        {
        ...
        public async Task<ServiceResult> CompleteSupportTicketAsync(ModeratorCompleteSupportTicketDTO requestDTO)
        {
            ServiceResult result = new();
        ...
        public async Task<ServiceResult<ModeratorSupportTicketDTO>> GetSupportTicketByIdAsync(long supportTicketId)
        {
        ...
        public async Task<ServiceResult<PaginatedList<ModeratorSummarySupportTicketDTO>>> GetSupportTicketsAsync(
            ModeratorSupportTicketsSpecificationsDTO specifications)
        {
            ServiceResult<PaginatedList<ModeratorSummarySupportTicketDTO>> result = new();
