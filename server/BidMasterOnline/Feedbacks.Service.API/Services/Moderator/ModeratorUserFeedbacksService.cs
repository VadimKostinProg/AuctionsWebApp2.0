...
{
    public class ModeratorUserFeedbacksService : IModeratorUserFeedbacksService
    {
        private readonly IRepository _repository;
        private readonly ModerationClient _moderationClient;
        private readonly ITransactionsService _transactionsService;
        private readonly ILogger<ModeratorUserFeedbacksService> _logger;

        public ModeratorUserFeedbacksService(IRepository repository,
            ModerationClient moderationClient,
            ITransactionsService transactionsService,
            ILogger<ModeratorUserFeedbacksService> logger)
        {
        ...
        public async Task<ServiceResult<PaginatedList<ModeratorUserFeedbackDTO>>> GetUserFeedbacksAsync(
            long userId,
            PaginationRequestDTO pagination)
        {
            ServiceResult<PaginatedList<ModeratorUserFeedbackDTO>> result = new();
